...
public class LivroServiceTests
{
    ...
    {
        _service = new LivroService(_repoMock.Object, _mapperMock.Object, _validatorMock.Object);
    }
    ...
    public async Task GetAllAsync_ShouldReturnMappedDtos()
    {
        ...
        {
            new Livro { Codl = 1, Titulo = "Livro 1", Editora = "Editora 1", Edicao = 1, AnoPublicacao = "2020" },
            new Livro { Codl = 2, Titulo = "Livro 2", Editora = "Editora 2", Edicao = 2, AnoPublicacao = "2021" },
            new Livro { Codl = 3, Titulo = "Livro 3", Editora = "Editora 3", Edicao = 3, AnoPublicacao = "2022" }
        };
        var dtos = new List<LivroResponseDto>
        {
            new LivroResponseDto { Codl = 1, Titulo = "Livro 1", Editora = "Editora 1", Edicao = 1, AnoPublicacao = "2020" },
            new LivroResponseDto { Codl = 2, Titulo = "Livro 2", Editora = "Editora 2", Edicao = 2, AnoPublicacao = "2021" },
            new LivroResponseDto { Codl = 3, Titulo = "Livro 3", Editora = "Editora 3", Edicao = 3, AnoPublicacao = "2022" }
        };
    ...
    {
        var livro = new Livro { Codl = 10, Titulo = "Livro X", Editora = "Editora X", Edicao = 1, AnoPublicacao = "2023" };
        var dto = new LivroResponseDto { Codl = 10, Titulo = "Livro X", Editora = "Editora X", Edicao = 1, AnoPublicacao = "2023" };
    ...
    {
        var request = new LivroRequestDto { Titulo = "Novo Livro", Editora = "Editora Nova", Edicao = 1, AnoPublicacao = "2024" };
        var livro = new Livro { Codl = 5, Titulo = "Novo Livro", Editora = "Editora Nova", Edicao = 1, AnoPublicacao = "2024" };
        var dto = new LivroResponseDto { Codl = 5, Titulo = "Novo Livro", Editora = "Editora Nova", Edicao = 1, AnoPublicacao = "2024" };
    ...
    {
        var id = 1;
        var request = new LivroRequestDto { Titulo = "Atualizado", Editora = "Editora", Edicao = 2, AnoPublicacao = "2025" };
        var livro = new Livro { Codl = id, Titulo = "Antigo", Editora = "Editora", Edicao = 1, AnoPublicacao = "2020" };
        var dto = new LivroResponseDto { Codl = id, Titulo = "Atualizado", Editora = "Editora", Edicao = 2, AnoPublicacao = "2025" };
